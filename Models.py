...
class TransE(KGE):
    ...
    def em_structure(self, h_pos, r_pos, t_pos, h_neg, r_neg, t_neg):
...
class TransH(KGE):
    ...
    def em_structure(self, h_pos, r_pos, t_pos, h_neg, r_neg, t_neg):
        ...
        h_neg = projector(h_neg, p_neg)
        t_neg = projector(t_neg, p_neg)
...
class TransD(KGE):
    ...
    def em_structure(self, h_pos, r_pos, t_pos, h_neg, r_neg, t_neg):
        ...
        h_neg = projector(h_neg, p_h_neg, p_r_neg)
        t_neg = projector(t_neg, p_t_neg, p_r_neg)
